// Package tfawsresource : verbatim copy of https://github.com/terraform-providers/terraform-provider-aws/blob/v2.67.0/aws/internal/tfawsresource/testing_test.go
